...
<body>
    ...
    <p><b>Hands-On Practice: </b>You’ll work on real-life projects to gain practical experience and build confidence in your skills.</p>
     ...
     <p><b> Experienced Instructors:</b> Our team of industry professionals will guide you every step of the way.</p>

    <p>Stay tuned! We’ll be in touch soon with more details on your schedule, course materials, and your first day of class.
    </p>
    <p>If you have any questions, feel free to reply to this email or reach out to us via our social media platforms DM.
    </p>
    <p>Looking forward to a fantastic journey ahead!
    </p>
    <p>Best!</p>
    <p>The Titrans Technology Team</p>
