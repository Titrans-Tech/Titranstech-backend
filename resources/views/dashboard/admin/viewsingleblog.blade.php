                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        value="{{ $viewsingle_blog->title }}" class="form-control" id="" placeholder="Title">
                    </div>
                    @error('title')
                    ...
                    <div class="form-group">
                      ...
                      value="{{ $viewsingle_blog->author }}" class="form-control" id="" placeholder="Author">
                  </div>
                  @error('author')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                     ...
                     <!-- /.form-group -->
                     <div class="form-group">
                        <img style="width: 50px; height: 50px;" src="{{ URL::asset("/public/../$viewsingle_blog->images")}}" alt="">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        value="{{ $viewsingle_blog->quote }}" class="form-control" id="" placeholder="Quote">
                    </div>
                    @error('quote')
                        <span class="text-danger">{{ $message }}</span>
                    @enderror
