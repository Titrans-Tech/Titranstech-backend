                  ...
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        value="{{ $viewsingle_jobs->title }}" class="form-control" id="" placeholder="Title">
                    </div>
                    @error('title')
                    ...
                    <div class="form-group">
                      ...
                      value="{{ $viewsingle_jobs->company }}" class="form-control" id="" placeholder="company">
                  </div>
                  @error('company')
                      <span class="text-danger">{{ $message }}</span>
                  @enderror
                     ...
                     <!-- /.form-group -->
                     <div class="form-group">
                        <img style="width: 50px; height: 50px;" src="{{ URL::asset("/public/../$viewsingle_jobs->images")}}" alt="">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            value="{{ $viewsingle_jobs->company_url }}" class="form-control" id="" placeholder="https://titranstech.co.uk">
                        </div>
                        @error('company_url')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="textarea" name="body" placeholder="Place some text here"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;">{{ $viewsingle_jobs->body }}</textarea>
